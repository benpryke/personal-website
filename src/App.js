...
My role thankfully permits the freedom to work with and move between multiple internal/external teams, self-direct and prioritise, and engage management at all levels. I am also fortunate enough to be able to learn from the incredibly smart, driven group of individuals that make Beacon.'/>
        ...
        <Logos title='Professional Relationships'>
          <Logo name='Beacon Platform' src='images/logos/logo-beacon.jpg' url='https://beacon.io'/>
          <Logo name='Dataquest' src='images/logos/logo-dataquest.png' url='https://www.dataquest.io'/>
          <Logo name='Machina Capital' src='images/logos/logo-machina-capital.png' url='https://www.linkedin.com/company/machina-capital'/>
          <Logo name='BRACE Dementia Research' src='images/logos/logo-brace.png' url='https://www.alzheimers-brace.org'/>
          <Logo name='EPSRC' src='images/logos/logo-epsrc.jpg' url='https://epsrc.ukri.org/'/>
          <Logo name='The Podcast Host' src='images/logos/logo-the-podcast-host.png' url='https://www.thepodcasthost.com'/>
          <Logo name='Seymour Pools' src='images/logos/logo-seymour-pools.jpg' url='https://seymourpools.co.uk'/>
          <Logo name='Bristol University' src='images/logos/logo-bristol.png' url='http://www.bris.ac.uk/engineering/departments/computerscience/'/>
          <Logo name='Edinburgh University' src='images/logos/logo-edinburgh.png' url='http://www.anc.ed.ac.uk/machine-learning/'/>
        </Logos>
        <Footer fadeIn={false}/>
      </div>
    );
